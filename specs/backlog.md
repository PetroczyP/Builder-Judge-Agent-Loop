...
| 20 | `init-agent-loop --check` environment diagnostics — verify scaffolded protocol is correctly installed: required files exist, status.json valid, slash commands registered, directory structure matches expected layout; report missing/broken items with fix suggestions; complements #13 (upgrade experience) | competitor-review | P2 | 2026-04-12 |
